...
# edit here
echo "----Copy Debug Fiele----"
STATIC_PATH=`pwd`/../static-binary
cp "${STATIC_PATH}/busybox/busybox-${ARCH}" "${IMAGE_DIR}/busybox"
cp "${STATIC_PATH}/gdbserver/gdbserver-${ARCH}" "${IMAGE_DIR}/gdbserver"
# edit end
